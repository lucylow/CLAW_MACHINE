...
export const isValidationError = (error: unknown): boolean => error instanceof AppError ? error.category === "validation" : false;
export const isProviderError = (error: unknown): boolean => error instanceof AppError ? ["storage", "compute", "chain", "external"].includes(error.category) : false;
...
export const isSkillExecutionError = (error: unknown): boolean => error instanceof AppError ? error.code === "SKILL_002_EXECUTION_FAILED" : false;
